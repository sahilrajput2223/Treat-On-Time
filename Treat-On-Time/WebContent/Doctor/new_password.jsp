                ...
                <div class="container">
						...
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="/Treat-On-Time/new_password_doctor" method="POST">
										</br>
											...
											<div class="col-md-10">
												<input type="email" value="<% out.print(session.getAttribute("forgot_password_email"));  %>" readonly name="email" class="form-control">
											</div>
										</div>
											</br>
										...
										<div class="form-group row">
											<label class="col-form-label col-md-2">New Confirm Password: </label>
											<div class="col-md-10">
