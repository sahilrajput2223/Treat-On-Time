                ...
                <div class="container">
						...
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="/Treat-On-Time/forgot_password_doctor" method="POST">
										</br>
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<input type="password" name="password_reset" placeholder="What's Your Nickname ??" class="form-control">
											</div>
										</div>
											</br>
